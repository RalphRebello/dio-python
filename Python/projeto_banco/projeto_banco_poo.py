...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excede_saldo:
            ...
            print('Operação não efetuada, valor inválido')
            return False
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            print('Valor do saque maior que o limite da conta')
        elif exedeu_saques:
...
def criar_cliente(clientes):
    ...
    print('Cliente cadastrador com sucesso')
